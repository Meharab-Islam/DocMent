...
import 'package:docment/feature/authentication/doctor/controller/doctor_login_controller.dart';
...
class DoctorLoginScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
     DoctorLoginController loginData =
        Get.put(DoctorLoginController(loginData: DoctorLoginData()));
                      ...
                      return Bounceable(
                          onTap: () {
                            if (_emailController.text.isEmpty ||
                              ...
                              var patientData = DoctorLoginModel(
